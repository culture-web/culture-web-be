...
router.get(
  '/summary',
  authenticateToken,
  proficiencyController.getUserProficiencySummary,
);
...
router.get(
  '/details',
  authenticateToken,
  proficiencyController.getUserProficiencyDetails,
);
...
router.get(
  '/concepts/:conceptId',
  authenticateToken,
  proficiencyController.getConceptProficiency,
);
...
router.get(
  '/suggestions',
  authenticateToken,
  proficiencyController.getLearningPathSuggestions,
);
...
router.get(
  '/curriculum',
  optionalAuth,
  proficiencyController.getCurriculumOverview,
);
...
router.get(
  '/categories/:category',
  optionalAuth,
  proficiencyController.getConceptsByCategory,
);
